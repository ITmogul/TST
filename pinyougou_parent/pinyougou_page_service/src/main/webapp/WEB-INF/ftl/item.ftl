		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${goods.categoryMap.categeory1Name}</a>
					</li>
					<li>
						<a href="#">${goods.categoryMap.categeory2Name}</a>
					</li>
					<li>
						<a href="#">${goods.categoryMap.categeory3Name}</a>
					</li>
								...
								<#list specList as spec>
								    <dl>
										...
										<#list spec.attributeValue as value>
										     <dd><a href="javascript:;" ng-click="updateSelected('${spec.attributeName}','${value}')" class="{{checkSelected('${spec.attributeName}','${value}')?'selected':''}}">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
										</#list>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a ng-click="addItemToCartList()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
